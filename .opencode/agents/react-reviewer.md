...
Do not assume the workflow prompt replaces the base rules. Combine the workflow prompt, the embedded sandbox rules, and any project guidance from `sandbox/knowledge/` that is relevant to the actual change set.
